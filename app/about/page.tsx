...
import pixel1 from "../pexels-1.jpg"
import pixel2 from "../pexels-2.jpg"
import pixel3 from "../pexels-3.jpg"
    ...
    return (
        ...
        <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-6 md:px-6">
            <div className="flex flex-wrap items-center">
                ...
                <div className="w-full px-4 mb-10 xl:w-1/2 lg:mb-8">
                    <span className="text-sm font-semibold text-red-500 dark:text-red-400">Why choose us</span>
